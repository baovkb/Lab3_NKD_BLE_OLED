...
#define SAMPLE_DEVICE_NAME          "NHOM2"
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    [IDX_SVC]        = {
        ...
        {ESP_GATT_AUTO_RSP}, //auto_rsp
        {
            ...
            sizeof(GATTS_SERVICE_UUID_TEST), //Current length of the element
            (uint8_t *)&GATTS_SERVICE_UUID_TEST //Element value array
        }
    },
            ...
            if (!param->write.is_prep){
                ...
                if (gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle && param->write.len == 8) {
                    if (param->write.value[2] == (uint8_t)'5' && param->write.value[3] == (uint8_t)'2') {
                        ...
                        vTaskDelay(100);
                        task_ssd1306_display_text(param->write.value);
                    } else {
                        ESP_LOGI(EXAMPLE_TAG, "Please input valid Id\n");
                    }
                }
